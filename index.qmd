...
<div class="event-cards reveal">
  ...
  <div class="event-card eu">
    ...
    <a class="card-link" href="https://rinpharma.com/contact.html">Join the Waitlist →</a>
  </div>
...
| **6:00–8:00pm**   | Posit Team                                    | 🍸 Social event — Posit Sponsored Apéro at *[Perron Basel](https://perron-basel.ch/en/)*, Vogesenplatz 1, 4056 Basel |
:::
...
**R/Pharma Workshops — Monday, September 14:**
...
| Time | Chair | Description |
|---|---|---|
| **9:00 – 9:30am** | *Phil Bowsher* (Posit), *Harvey Lieberman* (Novartis) & *Eric Nantz* (Director, Eli Lilly) | Welcome, introductions & kickoff — *Phil Bowsher* (Posit), *Harvey Lieberman* (Novartis) & *Eric Nantz* (Director, Eli Lilly) |
...
| **10:20 – 10:30am** | | Break |
| **10:30 – 11:20am** | *Eric Nantz* (Director, Eli Lilly) & *Dilip Raghunathan* (Regeneron) | <span class="tag tag-pharma">PHARMA AI</span> **Pharma AI in Practice** — lightning talks from *Eric Nantz* (Eli Lilly) and *Dilip Raghunathan* (Regeneron), followed by fireside discussion on AI application in pharma, pain points, and the submission side, including metadata-driven approaches |
| **11:30am – 12:30pm** | *Dror Berel* & *Eli Alexander Miller* (Atorus Research) | Lunch presentation & networking — proposals from *Dror Berel* (Biostatistics R Developer, Shiny/Teal) on Pharmaverse/Teal &amp; the public Teal Gallery Demos, and *Eli Alexander Miller* (Atorus Research) previewing R Consortium **Pilot 8** *(20 min each, pending confirmation)* |
| **12:30 – 12:40pm** | | Break |
...
| **6:00pm** | WU Consulting Group | 🍸 **Evening Mixer** — hosted by WU Consulting Group *(location TBD)* |
:::
...
<div class="speaker-row reveal">
  ...
  <div class="speaker-card">
    <div class="speaker-avatar">EN</div>
    <div class="speaker-info">
      <div class="speaker-name">Eric Nantz</div>
...
Attendees submit written questions throughout the morning; a panel answers them live and unscripted — a fast-paced way to surface the topics the room cares about most. *Panelists to be announced — check back as the agenda firms up.*
:::
...
🏨 The Summit is held at the **Hilton Americas-Houston** — the same hotel hosting posit::conf(2026) itself, so most attendees book their stay there directly through the [posit::conf registration page](https://conf.posit.co/2026/registration).
...
::: {.draft-notice}
🙋 **We need volunteer chairs!** Each table needs a chair to guide the conversation and take notes to report back. If you'd like to volunteer for one of the six tables below, [let us know here](https://rinpharma.com/contact.html) — we'll follow up to confirm.
:::
...
::: {.callout-note}
📺 **R/Pharma Virtual 2026 is a separate event from the summits on this page.** Workshops run **September 28 – October 1**, with presentations on **October 20–21**. [Register for R/Pharma Virtual here](https://events.zoom.us/ev/Ao58QRuKpY_AuvCDVGqF3tiibvbsLw6MKXn7n_PL2vPdHVQnSAuC~AulApVxluxkRoEef4TZ6ozp1uwmnBHGti8cDERG7p01yOGKH0KXFbLhUNw).
:::
