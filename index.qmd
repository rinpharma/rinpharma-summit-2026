...
::: {.draft-notice}
🎉 A Saturday night pre-summit hangout is in the works — details and an invite email will be sent soon.
:::
...
| **9:30 – 10:20am** | *Joe Cheng* (Posit) | <span class="tag tag-ai">AI</span> **The State of Regulatory Reproducibility** — *Joe Cheng* (Posit) on why FDA reviewers are increasingly requesting SAS-equivalent code alongside R submissions, and what that means as generic AI coding systems — for both programmers and autonomous agents — enter the regulatory pipeline. Covers the real failure modes behind "hard to reproduce" R submissions (environment mismatches, hidden setup assumptions, deeply nested code) and why those same failure modes get harder, not easier, to avoid when the code is AI-generated |
| **10:20 – 10:30am** | | Break |
