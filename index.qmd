...
<div class="topics-grid reveal">
  ...
  <div class="topic-card">
    ...
    <p>As agentic AI moves into GxP-regulated workflows, teams need concrete patterns for trust, safeguards, and governance before deploying these tools in the creation or QC of GxP study code. This table surfaces real-world lessons learned so far and tackles how to manage AI hallucinations in a regulated context. The goal is a shared, practical view of what "trustworthy agentic AI" actually looks like in pharma.</p>
  </div>

  <div class="topic-card">
    <span class="tag tag-ai">AI OPERATIONS</span>
    <h4>AI in Practice: Automation, Cost &amp; Skills</h4>
    <p>Beyond governance, teams are wrestling with practical questions: when deterministic automation beats AI-driven automation, how to manage token costs and benchmark agents and LLMs responsibly, and what IDE setups and upskilling paths actually work in a GxP-related context. This roundtable is about the operational side of AI adoption — cost, tooling, and training — comparing what's genuinely working today. Expect a practical toolkit, not just theory.</p>
  </div>

  <div class="topic-card env">
    <span class="tag tag-env">ENVIRONMENTS</span>
    <h4>Reproducible Environments &amp; Package Provisioning</h4>
    <p>Does renv make sense inside a Secure Computing Environment (SCE), and what does best-practice R package provisioning actually look like for GxP analyses? This table digs into the tradeoffs of environment management tools in validated, locked-down environments, drawing on real deployment experience. Attendees will leave with a clearer view of the options — and their limitations — for reproducible R environments in regulated pharma.</p>
  </div>
  ...
  <div class="topic-card pharma">
    ...
    <p>Are the industry's long-standing concerns about using open source like R in regulatory filings actually solved heading into 2026, or do they just look different now? This session extends that question to a related pain point — validating data exploration apps — to build a shared view of where open-source validation stands today. Expect input from people who have navigated real submissions.</p>
  </div>
  ...
  <div class="topic-card standards">
    ...
    <p>This is the community's most-discussed topic on GitHub — the architecture of parameterizable reporting and the case for standardized analysis results in a multi-technology, rapidly changing landscape. The roundtable digs into what a durable ARD/ARS standard needs to look like to survive shifting tech stacks and tooling. Given the interest already shown online, expect this table to be one of the most heavily attended.</p>
  </div>

  <div class="topic-card adoption">
    <span class="tag tag-panel">ADOPTION</span>
    <h4>Driving Adoption Beyond the Early Adopters</h4>
    <p>Most of us have lived this: "my colleagues still use Excel — now what?" This roundtable tackles the long tail of adoption — bringing skeptical or resource-constrained colleagues into modern, open-source workflows without alienating them. It's a conversation about change management as much as technology.</p>
  </div>
