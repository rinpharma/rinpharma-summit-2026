...
| **9:30 – 10:20am** | *Joe Cheng* (Posit) | <span class="tag tag-ai">AI</span> **The State of Regulatory Reproducibility** — *Joe Cheng* (Posit) on regulatory reproducibility in the age of AI: why Agency reviewers are asking harder questions of R submissions, and what changes when the code behind them comes from generic AI coding systems — written by a programmer or an autonomous agent alike |
| **10:20 – 10:30am** | | Break |
