...
<div class="virtual-note reveal">
  📺 Prefer virtual? <a href="https://events.zoom.us/ev/Ao58QRuKpY_AuvCDVGqF3tiibvbsLw6MKXn7n_PL2vPdHVQnSAuC~AulApVxluxkRoEef4TZ6ozp1uwmnBHGti8cDERG7p01yOGKH0KXFbLhUNw">R/Pharma Virtual 2026 registration is open →</a>
</div>
...
| **9:30 – 10:20am** | *Joe Cheng* (Posit) | <span class="tag tag-ai">AI</span> **The State of AI** — *Joe Cheng* (Posit) on reproducibility, trust, governance, skills, and R code vs. agent workflows |
| **10:20 – 10:30am** | | Break |
| **10:30 – 11:20am** | *Eric Nantz* (Eli Lilly) & *Dilip Raghunathan* (Regeneron) | <span class="tag tag-pharma">PHARMA AI</span> **Pharma AI in Practice** — lightning talks from *Eric Nantz* (Eli Lilly) and *Dilip Raghunathan* (Regeneron), followed by fireside discussion on AI application in pharma, pain points, and the submission side, including metadata-driven approaches |
...
<div class="faq-list reveal">
  ...
  <details class="faq-item">
    ...
    <div class="faq-answer">The US Summit is available as a standalone ticket ($599) or as an add-on with a posit::conf(2026) pass — see the registration link above. The EU (Basel) Summit has a small cost to help cover food and venue, since it isn't hosted on-site at a pharma company — it's a contributor-run event where the organizers and attendees travel in to make it happen, and a small number of extra spots may open up closer to the date. By contrast, R/Pharma Virtual — including its workshops and conference sessions — is completely free, a one-of-a-kind event made possible by pharma company sponsorship.</div>
  </details>
</div>
```
